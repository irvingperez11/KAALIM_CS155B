...
var blueNet, redNet, blueNetB, redNetB;
var clock;
var npc;
...
function addPurpleBalls()
{
	...
	for(i=0;i<numBalls;i++)
	{
		...
		{
			if (other_object==blueNet ||other_object==blueNetB )
			{
			...
			if (other_object==redNet || other_object==redNetB)
			{
