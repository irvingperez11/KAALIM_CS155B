...
function createMainScene()
{
  // setup lighting
	...
	scene.add(redNet);
	wall1 = createBoxMesh('wall.png');//Angel
	wall1.position.set(-23,0,12);
	...
	scene.add(wall1);
	wall2 = createBoxMesh('wall.png');//Angel
	wall2.position.set(-23,0,-12);
	...
	scene.add(wall2);
	wall3 = createBoxMesh('wall.png');//Angel
	wall3.position.set(23,0,12);
	...
	scene.add(wall3);
	wall4 = createBoxMesh('wall.png');//Angel
	wall4.position.set(23,0,-12);
	...
	scene.add(wall4);
	goalie1 = createConeMesh2(0xffff00);//Angel
	goalie1.position.set(-38,5,-4);
	...
	scene.add(goalie1);
	goalie2 = createConeMesh2(0xffff00);//Angel
	goalie2.position.set(38,5,4);
	...
	scene.add(goalie2);
	npc = createConeMesh('fire.png'); //Angel - modified so npc power is stronger
...
function addEvilBalls() //Angel - evil balls
{
	var numBalls = 5;
	for(i=0;i<numBalls;i++)
	{
...
function updateNPC() //Angel - modified so that npc power is stronger
{
